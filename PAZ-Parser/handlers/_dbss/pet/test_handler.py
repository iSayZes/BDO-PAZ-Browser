...
GRADE_CASE = HandlerCase(
    ...
    tests=[
        SchemaTest(required_keys=["variant", "species", "grade"]),
        CountTest(expected=203),
        PosTest(pos=0, expected={"key": 15878, "variant": 6, "species": 62, "grade": 2}),
        PosTest(pos=-1, expected={"key": 16641, "variant": 1, "species": 65, "grade": 2}),
    ],
)
